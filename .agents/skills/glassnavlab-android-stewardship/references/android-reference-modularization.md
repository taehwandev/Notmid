...
- The reference core-app module family owns app-facing shared Android/Compose infrastructure such as design-system, resources, network, lifecycle, dialog, toast, and permissions. In this repository, shrink that idea into `:core:runtime` packages unless a more specific Gradle boundary is proven.
